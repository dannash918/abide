...
export function ManagePrayersTab({}: ManagePrayersTabProps) {
  ...
  const [editingPoints, setEditingPoints] = useState<Array<{ id?: string; text: string; timePercentage?: number | null }>>([])
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setEditingPoints(topic.prayerPoints.map(p => ({ id: p.id, text: p.text, timePercentage: p.timePercentage ?? null })))
